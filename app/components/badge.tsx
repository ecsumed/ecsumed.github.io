...
function getBadge(color: string, text: string) {
    ...
    switch (color) {
        ...
        case "gray":
            return <span className="bg-gray-100 text-gray-800 text-xs font-medium me-2 px-2.5 py-0.5 rounded dark:bg-gray-700 dark:text-gray-400 border border-gray-500">{text}</span>;
        case "red":
            return <span className="bg-red-100 text-red-800 text-xs font-medium me-2 px-2.5 py-0.5 rounded dark:bg-gray-700 dark:text-red-400 border border-red-400">{text}</span>;
        case "green":
            return <span className="bg-green-100 text-green-800 text-xs font-medium me-2 px-2.5 py-0.5 rounded dark:bg-gray-700 dark:text-green-400 border border-green-400">{text}</span>;
        case "yellow":
...
export default function Badge({ color, text}: {color: string, text: string}) {
    return (
        getBadge(color, text)
    );
}