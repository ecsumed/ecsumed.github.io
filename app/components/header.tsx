                        ...
                        <ul className="flex">
                            ...
                            <li className="content-center">
                                <Link href="/about" className="px-3 group transition-all duration-300 ease-in-out">
                                    <span className="wwss bg-gradient-to-r from-amber-600 to-amber-600 bg-[length:0%_2px] bg-no-repeat group-hover:bg-[length:100%_2px] transition-all duration-500 ease-out">
                                        About
                                    </span>
                                </Link>
                            </li>
